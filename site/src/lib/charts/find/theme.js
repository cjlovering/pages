...
const modelColors = {
	'gpt-5':             '#AD2111', // accent red (best model)
	'gemini-2.5-pro':    '#7B5EA7', // muted purple
	'o3':                '#0E9EE4', // accent blue
	'gpt-5-mini':        '#2E7D8C', // teal
	'gemini-2.5-flash':  '#6A994E', // sage green
	'sonnet-v4':         '#E8890C', // warm amber
	'o3-mini':           '#D4803D', // copper
	'gpt-oss-120b':      '#8B5E3C', // brown
	'gpt-oss-20b':       '#969696', // ink-5 (gray)
	'gemma-3-27b-it':    '#C45B84', // dusty rose
	'gemma-3-12b-it':    '#B8860B'  // dark goldenrod
};

// SVG pattern types per model (for bar charts / print a11y)
const modelPatterns = {
	'gpt-5':             { type: 'diagonal', angle: 45, spacing: 6 },
	'gemini-2.5-pro':    { type: 'diagonal', angle: -45, spacing: 6 },
	'o3':                { type: 'dots', spacing: 7, r: 1.2 },
	'gpt-5-mini':        { type: 'crosshatch', spacing: 6 },
	'gemini-2.5-flash':  { type: 'horizontal', spacing: 5 },
	'sonnet-v4':         { type: 'vertical', spacing: 5 },
	'o3-mini':           { type: 'diagonal', angle: 30, spacing: 7 },
	'gpt-oss-120b':      { type: 'dots', spacing: 8, r: 1.5 },
	'gpt-oss-20b':       { type: 'crosshatch', spacing: 7 },
	'gemma-3-27b-it':    { type: 'horizontal', spacing: 6 },
	'gemma-3-12b-it':    { type: 'vertical', spacing: 6 },
	'Precision':         { type: 'diagonal', angle: 45, spacing: 6 },
	'Usefulness':        { type: 'diagonal', angle: 45, spacing: 6 }
};
